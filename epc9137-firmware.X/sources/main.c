...
#include "config/init/init_uart.h"
...
int main(void) {
    ...
    retval &= init_uart();        // Initialize uart
    ...
    retval &= appUart_Initialize();     // Initialize uart object and uart task
